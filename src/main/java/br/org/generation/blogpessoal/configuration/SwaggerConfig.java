...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Blog Pessoal").description("API do Projeto - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/jonataspribeiro")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Jonatas Palumbo Ribeiro", "https://github.com/jonataspribeiro", "jonataspalumbo1993@gmail.com");
	}
